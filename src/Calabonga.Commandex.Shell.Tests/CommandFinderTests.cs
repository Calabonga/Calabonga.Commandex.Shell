...
public class CommandFinderTests
{
    ...
    [Fact]
    public void CommandFinder_CanConvert_ToHierarchy_WithNoUntagged_if_no()
    {
    ...
    [Fact]
    public void CommandFinderShould_PutInGroupOne_CommandsTagged_One_Equals_1()
    {
        const int expected = 3;
    ...
    [Fact]
    public void CommandFinderShould_PutInGroupOne_CommandsTagged_Two_Equals_1()
    {
