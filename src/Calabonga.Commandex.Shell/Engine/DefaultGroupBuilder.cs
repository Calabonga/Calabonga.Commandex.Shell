...
public class DefaultGroupBuilder : IGroupBuilder
{
    ...
    {
        return new CommandGroup { Name = "Untagged", Description = "Group for untagged commandex command.", Tags = [] };
    }
    ...
    public List<CommandGroup> GetGroups()
    {
        ...
        [
            ...
            new()
            {
                Name = "Commands with Result",
                Tags = ["result"],
                Description = "Commands with some result for the Shell",
            ...
            new()
            {
                Name = "Commands open Dialog",
                Tags = ["dialog"],
                Description = "Commands that run into modal dialog window of the Shell",
